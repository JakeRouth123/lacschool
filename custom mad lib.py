...
class Application(Frame):
    ...
    def create_widgets(self):
        ...
        body_parts = ["foot", "epidermis", "teeth"]
        column = 1
        ...
        self.story_txt.grid(row =6, column = 2057, columnspan = 1)
